  ...
  return (
    <>
      ...
      <div className="h-64 w-96 relative">
          <div className="absolute top-28 left-20 md:top-36 md:left-8   min-h-56 w-56 rounded-full bg-color-accent shadow-xl shadow-color-gray"></div>
          <Image className="makeImageCircular absolute top-12 md:top-20 right-2 md:right-20 rounded-full p-16" src={coverImg} alt="..." width={700} height={700} style={{objectFit:"cover"}}/>
